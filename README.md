Goson [![Build Status](https://travis-ci.org/emilsjolander/goson.png)](https://travis-ci.org/emilsjolander/goson)
=====
...
goson.RenderTo(w io.Writer, template string, args Args)
```
